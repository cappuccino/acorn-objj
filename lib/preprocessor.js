...
var Preprocessor = function(parser, macroList)
{
    ...
    // When reading from a token stream, we reroute objj_readImportFilenameToken,
    // but need to restore it to the original when reading from source again.
    this.sourceReadImportFilenameToken = acorn.Parser.prototype.objj_readImportFilenameToken;

    acorn.Parser.prototype.objj_readImportFilenameToken = function()
    {
        this.objj.preprocessor.readImportFilenameToken.call(this);
    };
...
Preprocessor.prototype.defineMacro = function(definition, predefined)
{
    ...
    // Add \n at the end so that when the last token is replayed,
    // the input will not be considered to be exhausted.
...
Preprocessor.prototype.readFromSource = function()
{
    ...
    this.readImportFilenameToken = this.sourceReadImportFilenameToken;
};
...
Preprocessor.prototype.readFromStream = function()
{
    ...
    this.readImportFilenameToken = this.nextToken;
};
