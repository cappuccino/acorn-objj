        ...
        */
        ...
        if (!same)
        {
            issueHandler.addWarning(
                ...
                { start: macro.start, end: macro.end },
                "Warning: '" + macro.name + "' macro redefined"
            );
        }
    }
...
Preprocessor.prototype.pasteTokenSeries = function(macro, args, bodyTokens, i, lastPasteIndex)
{
...
Preprocessor.prototype.pasteTokens = function(leftToken, macro, index, args, pastedTokens)
{
    ...
    if (doPaste)
    {
        ...
        if (pastedToken === null)
        {
            var token = macro.tokens[index + 1],
                parser = this.parser;
        ...
        else pastedTokens.push(pastedToken);
    }
...
Preprocessor.prototype.parse = function(next)
{
    ...
    this.defineMacros(this.parser.objj.options.macros || []);
