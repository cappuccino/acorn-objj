...
Preprocessor.predefinedMacros.__OBJJ__ = function(options)
{
    return options.objj ? "1" : undefined;
};

/* istanbul ignore next */
Preprocessor.predefinedMacros.__BROWSER__ = function()
{
    return (typeof window === "undefined") ? undefined : "\"" + window.navigator.userAgent + "\"";
};

/* istanbul ignore next */
Preprocessor.predefinedMacros.__NODE__ = function()
{
