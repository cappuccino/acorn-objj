...
{
    // objj_readWord is also defined by pre-tokenize,
    // so we have to set this at runtime.
...
acorn.Parser.prototype.objj_readToken_dot = function(next)
{
    ...
    // If not parsing ES6+, check to see if an ellipsis is expected,
    // as is the case in an objj method with varargs.
    if (this.options.ecmaVersion < 6 && this.objj_getFlag("expectEllipsis"))
    {
