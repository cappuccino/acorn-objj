...
const overrides = {
    ...
    */
    ...
    {
        if (this.objj_getFlag(flags.kImplementation) || this.objj_getFlag(flags.kInterface))
        ...
        this.objj_setFlag(flags.kImplementation);
        ...
        this.objj_clearFlag(flags.kImplementation);
