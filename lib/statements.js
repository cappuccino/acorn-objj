...
{
    if (this.objj_getFlag("@implementation") || this.objj_getFlag("@interface"))
    ...
    this.objj_setFlag("@implementation");
    ...
    this.objj_clearFlag("@implementation");
...
acorn.Parser.prototype.objj_parseMethodDeclaration = function(node)
{
    ...
    while (true)
    {
        ...
        if (this.type === tt.comma)
        {
            ...
            this.objj_setFlag("expectEllipsis");
            this.next();
            this.expect(tt.ellipsis, "after ',' in method declaration");
            this.objj_clearFlag("expectEllipsis");
