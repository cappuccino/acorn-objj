...
acorn.Parser.prototype.objj_parsePreprocess = function()
{
    ...
    if (this.type === tt.eof && pp.ifStack.length > 0)
        this.raise(pp.ifStack[0].pos, "Unterminated " + pp.ifStack[0].type.label + " at EOF");
...
acorn.Parser.prototype.objj_readMacroBodyTokens = function(parameters, tokens, isVariadic, variadicParameterName)
{
...
acorn.Parser.prototype.objj_parseDefine = function()
{
    ...
    this.objj_readMacroBodyTokens(parameters, tokens, isVariadic, variadicParameterName);
    ...
    var macro = new Macro(name, nameStart, nameEnd, parameters, parameterMap, isFunction, isVariadic, tokens);
