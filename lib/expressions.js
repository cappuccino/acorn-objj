...
*/
acorn.Parser.prototype.objj_parseArrayLiteral = function(refDestructuringErrors)
{
    let node = this.startNode();
...
acorn.Parser.prototype.objj_parseDeref = function()
{
    ...
    node.objj = { ref: this.parseMaybeAssign(true) };
...
acorn.Parser.prototype.objj_parseObjectiveJType = function(startNode)
{
    ...
    let node = startNode ? this.startNodeAt(startNode.start) : this.startNode(),
        objj = {};
...
acorn.Parser.prototype.objj_parsePODType = function(objj)
{
    ...
    else
    {
        ...
        const isLong = this.type === tt._objj_long;
...
acorn.Parser.prototype.objj_parseMaybeMessageSend = function(refDestructuringErrors)
{
    /*
...
acorn.Parser.prototype.objj_parseExprAtom = function(next, refDestructuringErrors)
{
    switch (this.type)
    {
        case tt.bracketL:
        ...
        case tt._objj_super:
        {
            ...
            return this.finishNode(node, type === tt._objj_self ? "objj_Self" : "objj_Super");
        }
