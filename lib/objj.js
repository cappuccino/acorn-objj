...
{
    this.objj_expect(tt.braceL, "Expected '{' before dictionary");
...
acorn.Parser.prototype.objj_parseArrayLiteral = function(refShorthandDefaultPos)
{
    ...
    this.next();
    this.objj_expect(tt.bracketL, "Expected '[' at beginning of array literal");
...
exports.objjPlugin = acorn.plugins.objj = function(instance)
{
